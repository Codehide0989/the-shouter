...
export const Route = createFileRoute("/teams/check-in")({
  head: () => ({
    meta: [
      { title: "Match Check-In — The Shouter" },
      { name: "description", content: "Confirm attendance before match start." },
      { property: "og:title", content: "Match Check-In — The Shouter" },
      { property: "og:description", content: "Confirm attendance before match start." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <DashboardPage
      ...
      tagline="Confirm attendance before match start."
