...
export const Route = createFileRoute("/teams/chat")({
  head: () => ({
    meta: [
      { title: "Team Chat — The Shouter" },
      { name: "description", content: "Private squad channel, mirrored on Discord." },
      { property: "og:title", content: "Team Chat — The Shouter" },
      { property: "og:description", content: "Private squad channel, mirrored on Discord." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <DashboardPage
      eyebrow="Team"
      title="Team Chat"
      tagline="Private squad channel, mirrored on Discord."
