...
export const Route = createFileRoute("/bot/prefixes")({
  head: () => ({
    meta: [
      { title: "Prefixes — The Shouter" },
      { name: "description", content: "Change ! to anything per guild." },
      { property: "og:title", content: "Prefixes — The Shouter" },
      { property: "og:description", content: "Change ! to anything per guild." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <DashboardPage
      eyebrow="Bot"
      title="Prefixes"
      tagline="Change ! to anything per guild."
      heroKey="bot-mascot"
    >
