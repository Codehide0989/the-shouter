...
export const Route = createFileRoute("/bot/auto-roles")({
  head: () => ({
    meta: [
      { title: "Auto Roles — The Shouter" },
      { name: "description", content: "Assign roles on join." },
      { property: "og:title", content: "Auto Roles — The Shouter" },
      { property: "og:description", content: "Assign roles on join." },
    ],
  }),
  component: Page,
});
