...
export const Route = createFileRoute("/bot/logs")({
  head: () => ({
    meta: [
      { title: "Bot Logs — The Shouter" },
      { name: "description", content: "Trace every command and event." },
      { property: "og:title", content: "Bot Logs — The Shouter" },
      { property: "og:description", content: "Trace every command and event." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <DashboardPage
      eyebrow="Bot"
      title="Bot Logs"
      tagline="Trace every command and event."
