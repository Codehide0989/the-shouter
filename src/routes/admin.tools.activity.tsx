...
export const Route = createFileRoute("/admin/tools/activity")({
  head: () => ({ meta: [{ title: "Live Activity — Admin · The Shouter" }, { name: "robots", content: "noindex" }] }),
  component: Page,
});
...
function Page() {
  return (
    <DashboardPage
      eyebrow="Tools"
      title="Live Activity"
      tagline="Realtime firehose."
      heroKey="notice-hero"
      actions={<><NeoBadge variant="destructive">Admin</NeoBadge><NeoBadge variant="muted">Tools</NeoBadge></>}
    >
      <StatGrid items={[{"label":"Total","value":"3,531"},{"label":"This week","value":"272"},{"label":"Change","value":"+4%"},{"label":"Health","value":"OK"}]} />
      <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
        <ListPanel title="Recent activity" items={[{"id":"toolsactivity-0","primary":"Squad Rumble finals","secondary":"Discord #announcements","meta":"2m","tag":"New"},{"id":"toolsactivity-1","primary":"Artwork drop approved","secondary":"@shadow · #artwork","meta":"14m","tag":"Approved"},{"id":"toolsactivity-2","primary":"Bot resync completed","secondary":"12 guilds","meta":"1h","tag":"OK"},{"id":"toolsactivity-3","primary":"Ban appeal opened","secondary":"@ghostpixel","meta":"3h","tag":"Review"},{"id":"toolsactivity-4","primary":"Season rotated","secondary":"S4 → S5","meta":"yesterday","tag":"Ops"},{"id":"toolsactivity-5","primary":"Webhook retried","secondary":"orders.paid","meta":"yesterday","tag":"Retry"}]} />
