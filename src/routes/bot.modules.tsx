...
export const Route = createFileRoute("/bot/modules")({
  head: () => ({
    meta: [
      { title: "Modules — The Shouter" },
      { name: "description", content: "Toggle bot features per guild." },
      { property: "og:title", content: "Modules — The Shouter" },
      { property: "og:description", content: "Toggle bot features per guild." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <DashboardPage
      eyebrow="Bot"
      title="Modules"
      tagline="Toggle bot features per guild."
      heroKey="bot-mascot"
    >
