...
export const Route = createFileRoute("/bot/cleanup")({
  head: () => ({
    meta: [
      { title: "Cleanup — The Shouter" },
      { name: "description", content: "Delete old messages & orphaned channels." },
      { property: "og:title", content: "Cleanup — The Shouter" },
      { property: "og:description", content: "Delete old messages & orphaned channels." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <DashboardPage
      eyebrow="Bot"
      title="Cleanup"
      tagline="Delete old messages & orphaned channels."
