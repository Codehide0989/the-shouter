...
export const Route = createFileRoute("/bot/webhooks")({
  head: () => ({
    meta: [
      { title: "Webhooks — The Shouter" },
      { name: "description", content: "Outgoing hooks to any URL." },
      { property: "og:title", content: "Webhooks — The Shouter" },
      { property: "og:description", content: "Outgoing hooks to any URL." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <DashboardPage
      eyebrow="Bot"
      title="Webhooks"
      tagline="Outgoing hooks to any URL."
      heroKey="notice-hero"
    >
