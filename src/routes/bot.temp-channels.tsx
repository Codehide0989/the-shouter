...
export const Route = createFileRoute("/bot/temp-channels")({
  head: () => ({
    meta: [
      { title: "Temp Channels — The Shouter" },
      { name: "description", content: "Voice/text channels that self-destruct." },
      { property: "og:title", content: "Temp Channels — The Shouter" },
      { property: "og:description", content: "Voice/text channels that self-destruct." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <DashboardPage
      eyebrow="Bot"
      title="Temp Channels"
      tagline="Voice/text channels that self-destruct."
      heroKey="notice-drop"
    >
