...
export const Route = createFileRoute("/admin/analytics/growth")({
  head: () => ({ meta: [{ title: "Growth — Admin · The Shouter" }, { name: "robots", content: "noindex" }] }),
  component: Page,
});
...
function Page() {
  return (
    <DashboardPage
      eyebrow="Analytics"
      title="Growth"
      tagline="Week-over-week trend."
      heroKey="dash-rewards"
      actions={<><NeoBadge variant="destructive">Admin</NeoBadge><NeoBadge variant="muted">Analytics</NeoBadge></>}
    >
      <StatGrid items={[{"label":"Total","value":"1,385"},{"label":"This week","value":"98"},{"label":"Change","value":"+9%"},{"label":"Health","value":"OK"}]} />
      <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
        <ListPanel title="Recent activity" items={[{"id":"analyticsgrowth-0","primary":"Squad Rumble finals","secondary":"Discord #announcements","meta":"2m","tag":"New"},{"id":"analyticsgrowth-1","primary":"Artwork drop approved","secondary":"@shadow · #artwork","meta":"14m","tag":"Approved"},{"id":"analyticsgrowth-2","primary":"Bot resync completed","secondary":"12 guilds","meta":"1h","tag":"OK"},{"id":"analyticsgrowth-3","primary":"Ban appeal opened","secondary":"@ghostpixel","meta":"3h","tag":"Review"},{"id":"analyticsgrowth-4","primary":"Season rotated","secondary":"S4 → S5","meta":"yesterday","tag":"Ops"},{"id":"analyticsgrowth-5","primary":"Webhook retried","secondary":"orders.paid","meta":"yesterday","tag":"Retry"}]} />
