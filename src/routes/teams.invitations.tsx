...
export const Route = createFileRoute("/teams/invitations")({
  head: () => ({
    meta: [
      { title: "Team Invitations — The Shouter" },
      { name: "description", content: "Send, accept, decline in one click." },
      { property: "og:title", content: "Team Invitations — The Shouter" },
      { property: "og:description", content: "Send, accept, decline in one click." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <DashboardPage
      ...
      tagline="Send, accept, decline in one click."
      heroKey="dash-team"
    >
