...
export const Route = createFileRoute("/bot/auto-channels")({
  head: () => ({
    meta: [
      { title: "Auto Channels — The Shouter" },
      { name: "description", content: "Auto-create channels for events." },
      { property: "og:title", content: "Auto Channels — The Shouter" },
      { property: "og:description", content: "Auto-create channels for events." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <DashboardPage
      eyebrow="Bot"
      title="Auto Channels"
      tagline="Auto-create channels for events."
      heroKey="notice-hero"
    >
