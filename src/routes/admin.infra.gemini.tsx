...
export const Route = createFileRoute("/admin/infra/gemini")({
  head: () => ({ meta: [{ title: "Gemini — Admin · The Shouter" }, { name: "robots", content: "noindex" }] }),
  component: Page,
});
...
function Page() {
  return (
    <DashboardPage
      eyebrow="Infra"
      title="Gemini"
      tagline="Google AI keys & usage."
      heroKey="settings-hero"
      actions={<><NeoBadge variant="destructive">Admin</NeoBadge><NeoBadge variant="muted">Infra</NeoBadge></>}
    >
      <StatGrid items={[{"label":"Total","value":"2,347"},{"label":"This week","value":"176"},{"label":"Change","value":"+8%"},{"label":"Health","value":"OK"}]} />
      <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
        <ListPanel title="Recent activity" items={[{"id":"infragemini-0","primary":"Squad Rumble finals","secondary":"Discord #announcements","meta":"2m","tag":"New"},{"id":"infragemini-1","primary":"Artwork drop approved","secondary":"@shadow · #artwork","meta":"14m","tag":"Approved"},{"id":"infragemini-2","primary":"Bot resync completed","secondary":"12 guilds","meta":"1h","tag":"OK"},{"id":"infragemini-3","primary":"Ban appeal opened","secondary":"@ghostpixel","meta":"3h","tag":"Review"},{"id":"infragemini-4","primary":"Season rotated","secondary":"S4 → S5","meta":"yesterday","tag":"Ops"},{"id":"infragemini-5","primary":"Webhook retried","secondary":"orders.paid","meta":"yesterday","tag":"Retry"}]} />
