...
export const Route = createFileRoute("/bot/permissions")({
  head: () => ({
    meta: [
      { title: "Command Permissions — The Shouter" },
      { name: "description", content: "Who can run what, per role." },
      { property: "og:title", content: "Command Permissions — The Shouter" },
      { property: "og:description", content: "Who can run what, per role." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <DashboardPage
      ...
      tagline="Who can run what, per role."
