...
export const Route = createFileRoute("/admin/analytics/users")({
  head: () => ({ meta: [{ title: "Users Analytics — Admin · The Shouter" }, { name: "robots", content: "noindex" }] }),
  component: Page,
});
...
function Page() {
  return (
    <DashboardPage
      ...
      tagline="Signups, retention, cohorts."
      heroKey="dash-team"
      actions={<><NeoBadge variant="destructive">Admin</NeoBadge><NeoBadge variant="muted">Analytics</NeoBadge></>}
    >
      <StatGrid items={[{"label":"Total","value":"1,311"},{"label":"This week","value":"92"},{"label":"Change","value":"+7%"},{"label":"Health","value":"OK"}]} />
      <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
        <ListPanel title="Recent activity" items={[{"id":"analyticsusers-0","primary":"Squad Rumble finals","secondary":"Discord #announcements","meta":"2m","tag":"New"},{"id":"analyticsusers-1","primary":"Artwork drop approved","secondary":"@shadow · #artwork","meta":"14m","tag":"Approved"},{"id":"analyticsusers-2","primary":"Bot resync completed","secondary":"12 guilds","meta":"1h","tag":"OK"},{"id":"analyticsusers-3","primary":"Ban appeal opened","secondary":"@ghostpixel","meta":"3h","tag":"Review"},{"id":"analyticsusers-4","primary":"Season rotated","secondary":"S4 → S5","meta":"yesterday","tag":"Ops"},{"id":"analyticsusers-5","primary":"Webhook retried","secondary":"orders.paid","meta":"yesterday","tag":"Retry"}]} />
